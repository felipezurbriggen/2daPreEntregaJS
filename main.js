...
// <---CONSTRUCCION DEL OBJETO USUARIOS Y FUNCION CREAR USUARIOS--->
...
let equipo2 = new Equipo(2, "Orvis", "#7", "Orvis Cahil", "Orvis Clearwater", 0);
let equipo3 = new Equipo(3, "Gloomis", "#4", "STH MR Pop", "Scientific Anglers", 0);
...
if (numeroElegido === 1) {
  ...
  while (
    ...
    alert("Tenemos cuatro equipos para ofrecerte. Por favor elige uno según su número");
    alert(equipo1);
    alert(equipo2);
    alert(equipo3);
    alert(equipo4);
